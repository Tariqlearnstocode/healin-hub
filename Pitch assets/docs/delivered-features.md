...
- **Real photos on Chicago Dollz (2026-08-01, with Dawn's permission).** Four images from her own site (heart-hands lead, faja product shot, body-contouring diagram, skin photo) converted to the app's WebP display + thumbnail renditions and uploaded through the normal photo pipeline, replacing the two stock placeholders. She can reorder or swap them anytime in the photo manager.
